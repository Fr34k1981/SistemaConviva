...
# ======================================================
    ...
    <div class="conselho-online-hero">
        ...
        <p class="conselho-online-sub">
            Cada documento do Conselho foi transformado em página editável, com salvamento por turma/bimestre, importação da planilha da Prova Paulista e impressão em DOCX.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab_visao:
        ...
        with col_b2:
            ...
            if pagina:
                st.download_button("🖨️ Imprimir página: visão da turma", data=pagina, file_name=f"visao_{chave_conselho}.docx", mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", use_container_width=True, key="print_visao_conselho")
    ...
    with tab_ata:
        ...
        with col_print:
            ...
            if pagina:
                st.download_button("🖨️ Imprimir página: ata e rendimento", data=pagina, file_name=f"ata_rendimento_{chave_conselho}.docx", mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", use_container_width=True, key="print_ata_conselho")
    ...
    with tab_perfil:
        ...
        with col_p2:
            ...
            if pagina:
                st.download_button("🖨️ Imprimir página: perfil", data=pagina, file_name=f"perfil_{chave_conselho}.docx", mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", use_container_width=True, key="print_perfil_conselho")
    ...
    with tab_pec:
        ...
        with col_pec2:
            ...
            if pagina:
                st.download_button("🖨️ Imprimir página: protocolo PEC", data=pagina, file_name=f"protocolo_pec_{chave_conselho}.docx", mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", use_container_width=True, key="print_pec_conselho")
    ...
    with tab_focos:
        ...
        with col_f2:
            ...
            if pagina:
                st.download_button("🖨️ Imprimir página: focos", data=pagina, file_name=f"focos_{chave_conselho}.docx", mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", use_container_width=True, key="print_focos_conselho")
    ...
    with tab_pos:
        ...
        with col_pos2:
            ...
            if pagina:
                st.download_button("🖨️ Imprimir página: pós-conselho", data=pagina, file_name=f"pos_conselho_{chave_conselho}.docx", mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", use_container_width=True, key="print_pos_conselho")
    ...
    with tab_exportar:
        ...
        with col_e1:
            ...
            if docx_bytes:
                ...
                st.download_button("⬇️ Baixar Conselho completo preenchido em DOCX", data=docx_bytes, file_name=nome_docx, mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", use_container_width=True, key="baixar_docx_conselho_preenchido")
        ...
        with col_e2:
            ...
            for d in DOCUMENTOS_CONSELHO_PADRAO:
                ...
                if caminho.exists():
                    st.download_button(f"⬇️ {d['titulo']}", data=caminho.read_bytes(), file_name=caminho.name, mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document", key=f"download_modelo_original_{d['arquivo']}", use_container_width=True)
