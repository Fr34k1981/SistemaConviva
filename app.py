...
# ============================================================================
# CSS PERSONALIZADO (COM CORREÇÃO PARA ENCAMINHAMENTOS - 2 COLUNAS)
# ============================================================================
st.markdown("""
<style>
.main-header {
...
/* ✅ CORREÇÃO: ENCAMINHAMENTOS EM 2 COLUNAS - TEXTO NÃO QUEBRA */
.encam-container {
    background: #f8f9fa;
    padding: 1rem;
    border-radius: 8px;
...
# ============================================================================
# ENCAMINHAMENTOS DISPONÍVEIS (PARA CHECKBOX - 2 COLUNAS)
# ============================================================================
...
# ============================================================================
# 4. REGISTRAR OCORRÊNCIA (COM 2 COLUNAS PARA ENCAMINHAMENTOS - TEXTO LEGÍVEL)
# ============================================================================
    ...
    if df_alunos.empty:
        ...
        if len(alunos) > 0:
            ...
            with col2:
                ...
                # ✅ ENCAMINHAMENTOS EM CHECKBOX - 2 COLUNAS (TEXTO LEGÍVEL - NÃO QUEBRA)
                ...
                with st.container():
                    ...
                    # ✅ CORREÇÃO: 2 COLUNAS EM VEZ DE 4 (PARA TEXTO LEGÍVEL)
                    cols = st.columns(2)
...
# ============================================================================
    ...
    with col1:
        ...
        if st.button("📥 Baixar Backup de Dados", type="primary"):
            backup_buffer = criar_backup_dados(df_alunos, df_professores, df_responsaveis, df_ocorrencias)
            if backup_buffer:
                st.download_button(
    ...
    st.warning("⚠️ Atenção: Restaurar um backup irá sobrescrever os dados atuais!")
    ...
    if arquivo_backup is not None:
        try:
            ...
            if st.button("📤 Restaurar Dados", type="primary"):
                st.warning("⚠️ Esta ação não pode ser desfeita! Confirme que deseja restaurar.")
